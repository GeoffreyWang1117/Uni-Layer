...
class TestHessianTrace:
    ...
    def test_no_params_layer(self, simple_model, sample_data):
        ...
        result = m.compute(
            model=simple_model, layer=simple_model[1],  # ReLU has no params
...
class TestNTKTrace:
    ...
    def test_no_params(self, simple_model, sample_data):
        ...
        result = m.compute(
            model=simple_model, layer=simple_model[1],  # ReLU
            layer_name="1", layer_idx=1,
            data_loader=sample_data, device="cpu",
        )
...
class TestAttentionFlow:
    ...
    def test_with_multihead_attention(self):
        ...
        result = m.compute(
            model=model, layer=model.attn,
            layer_name="attn", layer_idx=1,
            data_loader=loader, device="cpu",
        )
...
def test_all_metrics_importable():
    ...
    metrics = [
        ...
        LaplacePosterior, AttentionFlow,
    ]
